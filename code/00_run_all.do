...
//   Stage 2: Panel construction (R) — merge pipeline (partially reconstructed)
//   Stage 3: Analysis + tables (Stata) — START HERE with derived data
//   Stage 4: Figures (R)
//
// STAGE 2 NOTE: The full merge pipeline is partially reconstructed.
//   See code/02_merge/02_merge_panels.R for details.
//   Replicators can start at Stage 3 using the provided data/derived/ files.
//
...
// ============================================================
// STAGE 3: Analysis + tables (Stata)
// Requires: data/derived/ populated (from Stages 1-2, or provided)
