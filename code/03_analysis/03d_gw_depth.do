...
coefplot ( mat(zero), ci((2  3)) \ sw0 \ sw1 \ sw2 \ sw3 ), aseq noeqlabels swapnames vertical xlab( 1 "0" 2 "1" 3 "2" 4 "3" 5 "4") recast(line) lwidth(1.5) ciopts(recast(rarea) color(*0.2%80 ) ) ytitle("{&Delta}DTW (ft)" "Cumulative Impuse Response" ) ylab(0(-2)-6) yline(0) scheme(s1mono) xtitle("Years since shock")
